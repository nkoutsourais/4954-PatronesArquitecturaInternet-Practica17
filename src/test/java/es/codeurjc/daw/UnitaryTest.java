...
public class UnitaryTest {
	...
	public void createPostTest() throws Exception{
		...
		MvcResult result = mvc.perform(
		  ...
		  PostFullDto resultPost = objectMapper.readValue(
	...
	public void createCommentTest() throws Exception {
		...
		PostFullDto post = new PostFullDto("Mi titulo", "Mi contenido con comentarios");
	...
	public void deleteCommentTest() throws Exception {
		...
		MvcResult createPostResult = mvc.perform(
		  ...
		  PostFullDto postCreated = objectMapper.readValue(
			createPostResult.getResponse().getContentAsString(), 
			PostFullDto.class
		);
		...
		CommentFullDto commentCreated = objectMapper.readValue(
			createCommentResult.getResponse().getContentAsString(), 
			CommentFullDto.class
		);
